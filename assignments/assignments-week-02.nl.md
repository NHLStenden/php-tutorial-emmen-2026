...
Maak het volgende „schilderij“ op een website met behulp van `display:grid`. Het „schilderij“ bestaat uit
rode/blauwe/witte/gele
...
Bekijk de twee afbeeldingen hieronder. Dit is een Facebook-overzicht van alle medewerkers in je virtuele bedrijf. Het
overzicht
moet alle medewerkers weergeven op ‘kaarten’, gescheiden door een kleine ‘spatie’. Er moeten zoveel mogelijk personen op
een ‘rij’ staan.
...
Als de pagina groter is dan de ruimte in de browser, moet er een verticale schuifbalk worden toegevoegd. Bekijk het
voorbeeld eens.
...
Gebruik de operatoren modulo (%) en deling (/), en uitsluitend deze operatoren, om de dag, maand en het jaar in
afzonderlijke
...
Implementeer de volgende beslissingstabel met behulp van PHP in combinatie met HTML. Definieer een variabele en stel
deze in op een waarde
