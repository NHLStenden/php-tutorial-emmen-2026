...
Have a look at [example 3](./index3.html). The CSS now uses a different `flex-grow` setting (3) for the second
...
at [example 5](./index5.html). Look at the CSS (non-important parts removed from the example below).
