...
// here are the "magic numbers" to make the search script run
$minValue = 0;
$maxValue = 20;
$lookingForValue = 5;

$test = random_int($minValue, $maxValue);

echo "$test\n";
$attempts = 1;

while ($test !== $lookingForValue) {
    $test = random_int($minValue, $maxValue);
    echo "$test\n";
    $attempts++;
}
echo "It took $attempts repeats for the randomizer to yield value $lookingForValue.\n";
