...
In PHP it is easy to read or write from a file. In the example below a file named 'information.txt' in the current
folder ( `` ) is read entirely in the variable $information.
